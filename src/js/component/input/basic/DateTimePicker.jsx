...
export default class DateTimePicker extends Input {
	...
	initComponent(){
      ...
      date: DateTimePickerConvertor.getAsString(this, this.getComponentValue()),
      defaultDate: DateTimePickerConvertor.getAsString(this, this.props.defaultValue),
	...
	getMinDate(){
		if(this.props.minDate != undefined){
			...
			if(this.props.minDate == "TODAY"){
				value = DateTimePickerConvertor.getAsString(this, moment().format(config.DEFAULT_DATETIME_SUBMIT_FORMATER));
			} else {
				value = DateTimePickerConvertor.getAsString(this, this.props.minDate);
			}
	...
	getMaxDate(){
		if(this.props.maxDate != undefined){
			...
			if(this.props.maxDate == "TODAY"){
				...
				value = DateTimePickerConvertor.getAsString(this, this.props.maxDate);
			}
