...
export default class MenuBar extends Component {
	...
	*/
	...
	renderMenuBarChildren(component){
		...
		if(component.props.visibled != undefined && !this.parseBool(this.getProperty("visibled", component))){
			return null;
		}
	...
	initComponent(){
		if(this.props.dataSource){
			let dataSource = this.getProperty("dataSource");//getDataSource();
