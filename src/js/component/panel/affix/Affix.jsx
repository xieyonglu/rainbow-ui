...
//	author: yonglu.xie
//	
//	description: Affix Component Class
//-----------------------------------------------------------------------------------------------
export default class Affix extends Component {
	...
	render(){
		return (
			 <div className="row">
        <div className="col-xs-3" id="myScrollspy">
            <ul className="ui-nav ui-nav-tabs ui-nav-stacked" id="myNav">
                <li className="active"><a href="#section-1">第一部分</a></li>
...
/**
 * Get Affix component default props
 */
Affix.defaultProps = {
