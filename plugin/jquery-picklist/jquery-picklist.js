...
(function($)
{
	$.widget("awnry.pickList",
	{
		...
		_buildSourceList: function()
		{
			...
			var container = $("<div id='" + self.options.id + "_container'/>")
		...
		_buildTargetList: function()
		{
			...
			self.targetList = $("<ul id='" + self.options.id + "_target_ul'/>")
					.addClass(self.options.listClass)
